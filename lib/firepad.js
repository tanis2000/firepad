...
firepad.Firepad = (function(global) {
  ...
  var ShareDBAdapter = firepad.ShareDBAdapter;
  ...
  function Firepad(ref, place, options) {
    ...
    if (ref !== null && typeof ref !== "undefined") {
      userId = this.getOption('userId', ref.push().key);
    } else {
      // TODO: when using ShareDB we should ask for a unique userId from the backend app
      userId = "TODO";
    }
    ...
    if (ref !== null && typeof ref !== "undefined") {
      ...
      this.firebaseAdapter_ = new ShareDBAdapter(ref, userId, userColor);
    }
    if (this.codeMirror_) {
